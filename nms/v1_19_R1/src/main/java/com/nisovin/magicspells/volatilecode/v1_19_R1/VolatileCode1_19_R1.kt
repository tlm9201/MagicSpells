...
class VolatileCode1_19_R1(helper: VolatileCodeHelper) : VolatileCodeHandle(helper) {
    ...
    init {
        try {
            ...
            helper.error("THIS OCCURRED WHEN CREATING THE VOLATILE CODE HANDLE FOR 1.19.2, THE FOLLOWING ERROR IS MOST LIKELY USEFUL IF YOU'RE RUNNING THE LATEST VERSION OF MAGICSPELLS.")
            e.printStackTrace()
        }
    }
